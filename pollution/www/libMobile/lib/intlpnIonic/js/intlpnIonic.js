...
var intlpnCtrl = function( $ionicModal, $scope, intlpnUtils ) {
    ...
    self.boxHeaderClass = angular.isDefined( self.boxHeaderClass )?self.boxHeaderClass:"mynavbar";
    self.boxHeaderTitle = angular.isDefined(self.boxHeaderTitle )?self.boxHeaderTitle:"Recherche";
